...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"FLConversations" inManagedObjectContext:self.managedObjectContext];
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"last_message_timestamp" ascending:NO];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[managedObject valueForKey:@"subject"] description];
//  **Figure out the name of the user you are taking with
//    cell.detailTextLabel.text = [[managedObject valueForKey:@"nickname"] description];
}
...
- (void)insertNewObject
{
    ...
    [newManagedObject setValue:[NSDate date] forKey:@"last_message_timestamp"];
